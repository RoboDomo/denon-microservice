...
This microservice communicates with Denon AVRs via serial API (over TCP) and bridges events and commands
via MQTT
...
```
$ docker build -t denon-microservice .
```
...
To restart it:
```
$ docker restart denon-micorservice
```
